  ...
  return (
    ...
    >
      ...
      <div className="mt-10 space-y-4 text-base text-[#4e3a2f]">
        ...
        <p>
          Master Alijanpour&apos;s artistic philosophy is rooted in the sacred transformation of classical miniature into a spiritual practice. He does not aim to replicate tradition but to transcend it. His brush reveals the invisible &mdash; the longing for unity, the silent presence of the divine feminine, and the cosmic dance between shadow and light.
        </p>
        <p className="italic text-sm text-[#7c6f63]">
          &ldquo;Painting is not what I do — it&apos;s how I breathe the light in darkness.&rdquo;
        </p>
      </div>
