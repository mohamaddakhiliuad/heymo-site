...
export default {
  ...
  booking: {
    ...
    free: {
      ...
      desc: "20–30 minutes (EN/FA)",
      ctaCal: "Book on Cal.com",
    },
    coaching: {
      title: "Coaching Session",
      desc: "60 minutes (online)",
      ctaCal: "Schedule",
      ctaStripe: "Pay with Stripe",
    },
    mbsr: {
      title: "MBSR Registration",
      desc: "8-week program (group)",
  ...
  contact: {
    ...
    form: {
      ...
      agree: "I agree to receive replies related to my inquiry.",
      submit: "Send Message",
      sending: "Sending…",
      successTitle: "Sent!",
      successDesc: "Thanks—your message has been delivered.",
      errorTitle: "Oops!",
      errorDesc: "Something went wrong. Please try again.",
      required: "This field is required",
      invalidEmail: "Please enter a valid email",
      minMsg: "Message should be at least 10 characters",
    },
    alt: {
